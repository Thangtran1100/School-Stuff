...
/**
 * Servlet implementation class AssignedUpdate
 */
@WebServlet("/AssignedUpdate")
public class AssignedUpdate extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("AssignedUpdate.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        for( HelpdeskEntry entry : entries )
        {
        	if(requestId == entry.getRequestId())
        	{
        		...
        		{
        			entry.setRequestStatus("Completed");
        		}
        		
        		if(status.equals("Cancelled"))
        		{
        			entry.setRequestStatus("Cancelled");
        		}
